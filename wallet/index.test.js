...
describe('Wallet', () => {
  ...
  describe('calculateBlance()', () => {
    ...
    describe('and there are outputs for the waller', () => {
      ...
      it('adds the sums of all outputs to the wallet address', () => {
        expect(
          Wallet.calculateBalance({
            chain: blockchain.chain,
            address: wallet.publicKey
    ...
    describe('and the wallet has made a transaction', () => {
      ...
      describe('and there are utputs next to nd after the recent transaction', () => {
