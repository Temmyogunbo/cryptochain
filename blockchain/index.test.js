...
describe('Blockchain', () => {
  ...
  beforeEach(() => {
    // before each run for every test creating a new instance
  ...
  describe('isValidChain()', () => {
    ...
    describe('when the chain starts with the genesis block and has multipe blocks', () => {
      beforeEach(() => {
  ...
  describe('replaceChain', () => {
    ...
    describe('when chain is longer', () => {
      beforeEach(() => {
        // add bock to have a longer chain
  ...
  describe('and the validateTransactionData` is true', () => {
 ...
 describe('validTransactionData()', () => {
   ...
   describe('and the transaction data has at least one malformed outputMap', () => {
     describe('and the transaction is not a reward a transaction', () => {
      it('returns false and logs an error', () => {
